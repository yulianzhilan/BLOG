...
public class Pagination implements Serializable {
    ...
    //public static final int DEFAULT_PAGE_SIZE = GlobalConfig.getDefaultPageSize(); // 每页显示的记录数
    ...
    public boolean hasNextPage() {
        if (this.pageCount < 1 || getStartIndex() == (this.pageCount - 1) * this.pageSize)
            return false;
        return true;
    }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof Pagination))
            return false;
        Pagination another = (Pagination) obj;
        return (getPageSize() == another.getPageSize()) && (getStartIndex() == another.getStartIndex()) && (getTotalCount() == another.getTotalCount());
    }
    ...
    public String toString() {
        return "[pagesize = " + this.getPageSize() + ", startIndex = " + this.startIndex + ", endIndex = " + this.getEndIndex() + ", pageCount = "
                + +this.getPageCount() + ", totalcount = " + this.getTotalCount() + ", currentpage = " + +this.getCurrentPage() + "]";
    }
}